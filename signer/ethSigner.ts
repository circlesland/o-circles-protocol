// From https://github.com/gnosis/safe-react - src/logic/safe/transactions/offchainSigner/ethSigner.ts
...
export const ethSigner = async (web3:Web3, { safeTxHash, sender }: EthSignerArgs): Promise<string> => {
